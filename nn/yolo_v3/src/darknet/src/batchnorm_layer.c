...
void forward_batchnorm_layer(layer l, network net)
{
    ...
    if(net.train) {
        float momentum = net.bn_momentum;

        mean_cpu(l.output, l.batch, l.out_c, l.out_h*l.out_w, l.mean);
        variance_cpu(l.output, l.mean, l.batch, l.out_c, l.out_h*l.out_w, l.variance);

        scal_cpu(l.out_c, 1. - momentum, l.rolling_mean, 1);
        axpy_cpu(l.out_c, momentum, l.mean, 1, l.rolling_mean, 1);
        scal_cpu(l.out_c, 1. - momentum, l.rolling_variance, 1);
        axpy_cpu(l.out_c, momentum, l.variance, 1, l.rolling_variance, 1);
...
void forward_batchnorm_layer_gpu(layer l, network net)
{
    ...
    if (net.train) {
        ...
        scal_gpu(l.out_c, 1. - momentum, l.rolling_mean_gpu, 1);
        axpy_gpu(l.out_c, momentum, l.mean_gpu, 1, l.rolling_mean_gpu, 1);
        scal_gpu(l.out_c, 1. - momentum, l.rolling_variance_gpu, 1);
        axpy_gpu(l.out_c, momentum, l.variance_gpu, 1, l.rolling_variance_gpu, 1);
