...
project_objects = pcd_ann_json.get("objects")
pcd_object_id = project_objects[0]["id"]

object_tag_id = api.pointcloud.object.tag.add(new_tag_meta.sly_id, pcd_object_id, value="car_1")

# stop here to check add
api.pointcloud.object.tag.update(object_tag_id, value="car_2")

# stop here to check update
api.pointcloud.object.tag.remove(object_tag_id)
