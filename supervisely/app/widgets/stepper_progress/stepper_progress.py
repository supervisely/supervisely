...
class StepperProgress(Widget):
    ...
    def __init__(
        ...
        assert all(isinstance(item, StepperProgress.StepItem) for item in self._items), RuntimeError("All items must be of type StepperProgress.StepItem")
    ...
    def get_json_state(self) -> Dict:
        return {"active": self._active_step, "spacing": self._spacing}
