    ...
    class Context:
        ...
        def print_destination(self):
            if (
                ...
                if self.dataset_id is not None:
                    print(
                        f"Files will be uploaded to the following destination:"
