...
from supervisely.nn.benchmark.evaluation.semantic_segmentation.image_diversity.clip.model import (
    build_model,
)
from supervisely.nn.benchmark.evaluation.semantic_segmentation.image_diversity.clip.simple_tokenizer import (
