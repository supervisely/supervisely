...
class CloudImportAutomation(AutomationWidget):
    ...
    DESCRIPTION = (
        "Schedule synchronization from the Cloud Storage to the Input Project. "
        "Specify the folder path and the time interval for synchronization."
    )

    def __init__(self, func: Callable):
        super().__init__(self.DESCRIPTION, func)
