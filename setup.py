...
INSTALL_REQUIRES = [
    ...
    "pydantic>=1.7.4, <2.0.0", # for tests
    ...
    "urllib3>=1.26.15, <2.0.0", # for tests
    "cacheout==0.14.1",
    # "jsonschema>=2.6.0,<=4.20.0",
    "jsonschema>=2.6.0,<3.0.0", # for tests
    "pyjwt>=2.1.0,<3.0.0",
]
