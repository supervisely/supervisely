...
def local_version_label(branch_name: str) -> str:
    # PEP 440 local labels take alphanumerics and periods only, so a branch whose name
    # holds a slash (`agent/6094-work`) makes setuptools reject the built version.
