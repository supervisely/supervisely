...
from supervisely_lib import generate_random_string
...
############################################################################################################
    ...
    def _calc_result_meta(self):
        ...
        def get_dest_layers(the_layer):
            the_dest_layers = []
            for dest_id in the_layer.dsts:
                temp = [l for l in self.layers if dest_id in l.srcs]
                the_dest_layers.extend(temp)
            return the_dest_layers
