...
class ImporterMapillary:
    ...
    def _imgs_dir(self, ds_name):
        return osp.join(self.in_dir, ds_name, 'images')

    def _segm_dir(self, ds_name):
        return osp.join(self.in_dir, ds_name, 'labels')

    def _inst_dir(self, ds_name):
        return osp.join(self.in_dir, ds_name, 'instances')
    ...
    def convert(self):
        ...
        for ds_name, sample_names in self.src_datasets.items():
            for name in sample_names:
                dt = {
                    'src_img_path': osp.join(self._imgs_dir(ds_name), name + '.jpg'),
